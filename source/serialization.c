...
static inline unsigned char *serialize_int(unsigned char *buffer, uint32_t value) {
...
static inline unsigned char *deserialize_str(unsigned char *buffer, char *result,
